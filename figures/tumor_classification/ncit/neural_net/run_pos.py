...
with open(cwd / 'figures' / 'tumor_classification' / 'ncit' / 'neural_net' / 'results' / 'bin_weights.pkl', 'wb') as f:
...
with open(cwd / 'figures' / 'tumor_classification' / 'ncit' / 'neural_net' / 'results' / 'bin_predictions.pkl', 'wb') as f:
