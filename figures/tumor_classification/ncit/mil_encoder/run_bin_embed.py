...
with open(cwd / 'figures' / 'tumor_classification' / 'ncit' / 'mil_encoder' / 'results' / 'bin_embed_weights.pkl', 'wb') as f:
...
with open(cwd / 'figures' / 'tumor_classification' / 'ncit' / 'mil_encoder' / 'results' / 'bin_embed_predictions.pkl', 'wb') as f:
