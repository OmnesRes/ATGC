...
mil.model.set_weights(weights[3])
...
indexes = [np.where(D['sample_idx'] == idx) for idx in samples.iloc[idx_test].loc[samples.iloc[idx_test]['NCIt_label'] == cancer].index]
...
for cancer in cancer_to_code:
    ...
    weighted_del_background_ref_matrix = weighted_del_background_ref_matrix + (cancer_del_background_ref_matrix * len(samples.iloc[idx_test].loc[samples.iloc[idx_test]['NCIt_label'] == cancer]))
    ...
    weighted_ins_background_alt_matrix = weighted_ins_background_alt_matrix + (cancer_ins_background_alt_matrix * len(samples.iloc[idx_test].loc[samples.iloc[idx_test]['NCIt_label'] == cancer]))
    ...
    weighted_del_background_five_p_matrix = weighted_del_background_five_p_matrix + (cancer_del_background_five_p_matrix * len(samples.iloc[idx_test].loc[samples.iloc[idx_test]['NCIt_label'] == cancer]))
    ...
    weighted_ins_background_five_p_matrix = weighted_ins_background_five_p_matrix + (cancer_ins_background_five_p_matrix * len(samples.iloc[idx_test].loc[samples.iloc[idx_test]['NCIt_label'] == cancer]))
    ...
    weighted_del_background_three_p_matrix = weighted_del_background_three_p_matrix + (cancer_del_background_three_p_matrix * len(samples.iloc[idx_test].loc[samples.iloc[idx_test]['NCIt_label'] == cancer]))
    ...
    weighted_ins_background_three_p_matrix = weighted_ins_background_three_p_matrix + (cancer_ins_background_three_p_matrix * len(samples.iloc[idx_test].loc[samples.iloc[idx_test]['NCIt_label'] == cancer]))
