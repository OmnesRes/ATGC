...
##sample heatmap
mask = samples.iloc[idx_test]['NCIt_label'] == 'Cutaneous Melanoma'
aggregations = aggregations[:, cancer_to_code['Cutaneous Melanoma'], :][mask]
prediction = prediction_probabilities[mask][:, cancer_to_code['Cutaneous Melanoma']]
