...
with open(cwd / 'figures' / 'tumor_classification' / 'project' / 'mil_encoder' / 'results' / 'bin_embed_weights_100k.pkl', 'wb') as f:
...
with open(cwd / 'figures' / 'tumor_classification' / 'project' / 'mil_encoder' / 'results' / 'bin_embed_predictions_100k.pkl', 'wb') as f:
