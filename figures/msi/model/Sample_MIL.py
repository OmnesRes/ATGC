...
from figures.msi.model.KerasLayers import Activations, Ragged, Embed, StrandWeight, Dropout
...
class InstanceModels:
    ...
    class VariantSequence:
        ...
        def build(self, *args, **kwargs):
            ...
            # fused = tf.reduce_max(fused, axis=1)
            # self.model = tf.keras.Model(inputs=[five_p, three_p, ref, alt], outputs=[fused])
