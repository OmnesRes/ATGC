...
tcga_maf.drop_duplicates(subset=['Chromosome', 'Start_Position', 'End_Position', 'Reference_Allele', 'Tumor_Seq_Allele2'], inplace=True)
tcga_maf.dropna(subset=['Reference_Allele', 'Tumor_Seq_Allele2'], inplace=True)
