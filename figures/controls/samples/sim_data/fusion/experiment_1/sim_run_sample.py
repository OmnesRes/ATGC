...
for i in range(3):
    ...
    mil = RaggedModels.MIL(instance_encoders=[sequence_encoder.model, position_encoder.model], output_dim=2, pooling='sum')
...
# with open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'fusion' / 'experiment_1' / 'instance_layers.pkl', 'wb') as f:
