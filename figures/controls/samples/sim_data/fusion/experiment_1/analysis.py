...
mil = RaggedModels.MIL(instance_encoders=[sequence_encoder.model, position_encoder.model], output_dim=2, pooling='sum', instance_layers=[128, 64])
attentions = []
evaluations, histories, weights = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'fusion' / 'experiment_1' / 'instance_layers.pkl', 'rb'))
for i in range(3):
...
with open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'fusion' / 'experiment_1' / 'instance_layers_attentions.pkl', 'wb') as f:
