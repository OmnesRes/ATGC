...
from model.Sample_MIL import InstanceModels, RaggedModels
evaluations, histories, weights = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_2' / 'sample_model_attention_dynamic.pkl', 'rb'))
...
with open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_2' / 'sample_model_attention_dynamic_predictions.pkl', 'wb') as f:
