...
idx_test, mean_predictions, mean_attentions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_mean_predictions.pkl', 'rb'))
idx_test, sum_predictions, sum_attentions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_sum_predictions.pkl', 'rb'))
idx_test, dynamic_predictions, dynamic_attentions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_dynamic_predictions.pkl', 'rb'))
