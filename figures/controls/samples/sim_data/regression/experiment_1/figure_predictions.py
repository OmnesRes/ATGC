...
idx_test, instance_sum_predictions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'instance_model_sum_predictions.pkl', 'rb'))
idx_test, instance_mean_predictions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'instance_model_mean_predictions.pkl', 'rb'))
idx_test, sample_sum_predictions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_sum_predictions.pkl', 'rb'))
idx_test, sample_mean_predictions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_mean_predictions.pkl', 'rb'))
...
plt.savefig(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'figure_predictions.png', dpi=300)
