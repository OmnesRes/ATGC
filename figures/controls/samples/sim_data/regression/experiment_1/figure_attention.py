...
idx_test, predictions, mean_attentions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_mean_predictions.pkl', 'rb'))
idx_test, predictions, sum_attentions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_sum_predictions.pkl', 'rb'))
idx_test, predictions, both_attentions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_both_predictions.pkl', 'rb'))
idx_test, predictions, dynamic_attentions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_dynamic_predictions.pkl', 'rb'))
...
plt.savefig(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_1' / 'attention.png', dpi=300)
