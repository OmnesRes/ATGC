...
def generate_sample(mean_variants=[5, 10, 20, 30, 40, 50, 70, 100, 150, 200, 250, 300],
    ...
    sample_value = np.random.normal(np.ceil(positive_count * 100 / total_count), np.ceil(positive_count * 10 / total_count))
    if sample_value < 0:
        sample_value *= -1
...
with open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'regression' / 'experiment_3' / 'sim_data.pkl', 'wb') as f:
