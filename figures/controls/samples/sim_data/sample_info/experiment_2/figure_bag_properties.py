...
ax.set_ylabel('Bag Value', fontsize=16, labelpad=10)
...
plt.savefig(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'sample_info' / 'experiment_2' / 'figure_bag_properties.png', dpi=300)
