...
sample_both_before_evaluations, sample_both_before_histories, weights = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'sample_info' / 'experiment_2' / 'sample_model_both_before.pkl', 'rb'))
sample_both_after_evaluations, sample_both_after_histories, weights = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'sample_info' / 'experiment_2' / 'sample_model_both_after.pkl', 'rb'))
