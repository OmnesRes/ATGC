...
type_loader = DatasetsUtils.Map.FromNumpy(types, tf.int32)
...
with open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_dynamic_before.pkl', 'wb') as f:
