...
mil = RaggedModels.MIL(instance_encoders=[sequence_encoder.model], sample_encoders=[sample_encoder.model], output_dim=1, pooling='both', output_type='other', sample_layers=[64, ], pooled_layers=[32, ])
