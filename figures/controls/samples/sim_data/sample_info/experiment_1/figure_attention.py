...
idx_test, both_before_attentions, predictions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_both_before_eval.pkl', 'rb'))
idx_test, both_after_attentions, predictions = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_both_after_eval.pkl', 'rb'))
...
attention = np.concatenate([np.concatenate(sum_before_attentions[0][:20]),
                            ...
                            np.concatenate(both_before_attentions[0][:20]),
                            np.concatenate(both_after_attentions[0][:20]),
