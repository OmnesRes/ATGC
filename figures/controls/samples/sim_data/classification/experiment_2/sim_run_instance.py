...
for i in range(3):
    ...
    mil = RaggedModels.MIL(instance_encoders=[tile_encoder.model], output_dim=1, pooling='mean')
    ...
    callbacks = [tf.keras.callbacks.EarlyStopping(monitor='val_binary_crossentropy', min_delta=0.00001, patience=100, mode='min', restore_best_weights=True)]
...
with open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'classification' / 'experiment_2' / 'instance_model_mean.pkl', 'wb') as f:
