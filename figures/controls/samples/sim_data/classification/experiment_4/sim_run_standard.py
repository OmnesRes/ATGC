...
logistic_metrics = []
for i in range(3):
    reg = RandomForestClassifier(n_estimators=100, min_samples_split=2, random_state=0, n_jobs=10)
...
with open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'classification' / 'experiment_4' / 'standard_metrics.pkl', 'wb') as f:
