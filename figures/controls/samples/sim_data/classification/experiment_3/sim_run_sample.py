...
for i in range(3):
    ...
    mil = RaggedModels.MIL(instance_encoders=[tile_encoder.model], pooling='sum', regularization=.05)
...
with open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'classification' / 'experiment_3' / 'sample_model_attention_sum.pkl', 'wb') as f:
