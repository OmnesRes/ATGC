...
instance_sum_indexes, instance_sum_ranks, instance_sum_sample_dfs = pickle.load(open(cwd / 'figures' / 'controls' / 'samples' / 'sim_data' / 'survival' / 'experiment_1' / 'instance_model_sum_eval.pkl', 'rb'))
