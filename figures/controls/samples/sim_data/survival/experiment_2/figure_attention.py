...
sample_sum_attention_indexes, sample_sum_attention_ranks, sample_sum_attention_sample_dfs, sum_attentions = pickle.load(open(cwd / 'sim_data' / 'survival' / 'experiment_2' / 'sample_model_attention_sum_eval.pkl', 'rb'))
sample_both_attention_indexes, sample_both_attention_ranks, sample_both_attention_sample_dfs, both_attentions = pickle.load(open(cwd / 'sim_data' / 'survival' / 'experiment_2' / 'sample_model_attention_both_eval.pkl', 'rb'))
sample_dynamic_attention_indexes, sample_dynamic_attention_ranks, sample_dynamic_attention_sample_dfs, dynamic_attentions = pickle.load(open(cwd / 'sim_data' / 'survival' / 'experiment_2' / 'sample_model_attention_dynamic_eval.pkl', 'rb'))
