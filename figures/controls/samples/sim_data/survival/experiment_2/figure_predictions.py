...
instance_sum_indexes, instance_sum_ranks, instance_sum_sample_dfs = pickle.load(open(cwd / 'sim_data' / 'survival' / 'experiment_2' / 'instance_model_sum_eval.pkl', 'rb'))
...
sample_df = instance_sum_sample_dfs[4].append(sample_sum_sample_dfs[4]).append(sample_sum_attention_sample_dfs[4]).append(sample_both_attention_sample_dfs[0]).append(sample_dynamic_attention_sample_dfs[4])
