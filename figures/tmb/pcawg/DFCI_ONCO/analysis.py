...
all_weights = [pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'DFCI_ONCO' / 'results' / 'run_naive.pkl', 'rb')),
          pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'DFCI_ONCO' / 'results' / 'run_position.pkl', 'rb')),
           pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'DFCI_ONCO' / 'results' / 'run_sequence.pkl', 'rb'))
            ]
