...
D, samples, maf, sample_df = pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'DFCI_ONCO' / 'data' / 'data_cds.pkl', 'rb'))
...
all_weights = [
    pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'DFCI_ONCO' / 'results' / 'run_naive_cds.pkl', 'rb')),
    pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'DFCI_ONCO' / 'results' / 'run_position_cds.pkl', 'rb')),
    pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'DFCI_ONCO' / 'results' / 'run_sequence_cds.pkl', 'rb'))
    ]
...
results['counting'] = np.log(sample_df['panel_non_syn_counts'].values[np.concatenate(test_idx)] / (panels.loc[panels['Panel'] == 'DFCI-ONCOPANEL-3']['cds'].values[0]/1e6) + 1)

with open(cwd / 'figures' / 'tmb' / 'pcawg' / 'DFCI_ONCO' / 'results' / 'predictions.pkl', 'wb') as f:
