...
D, samples, maf, sample_df = pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'VICC_01_R2' / 'data' / 'data_all.pkl', 'rb'))
...
all_weights = [
    pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'VICC_01_R2' / 'results' / 'run_naive_all.pkl', 'rb')),
    pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'VICC_01_R2' / 'results' / 'run_position_all.pkl', 'rb')),
    pickle.load(open(cwd / 'figures' / 'tmb' / 'pcawg' / 'VICC_01_R2' / 'results' / 'run_sequence_all.pkl', 'rb'))
    ]
