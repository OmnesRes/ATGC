...
all_weights = [
    pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'MSK_341' / 'results' / 'run_naive_shuffle.pkl', 'rb')),
    pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'MSK_341' / 'results' / 'run_position_shuffle.pkl', 'rb')),
    pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'MSK_341' / 'results' / 'run_sequence_shuffle.pkl', 'rb'))
    ]
...
results['counting'] = np.log(sample_df['panel_non_syn_counts'].values[np.concatenate(test_idx)] / (panels.loc[panels['Panel'] == 'MSK-IMPACT341']['cds'].values[0]/1e6) + 1)
