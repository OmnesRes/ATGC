...
all_weights = [pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'MSK_341' / 'results' / 'run_naive.pkl', 'rb')),
          pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'MSK_341' / 'results' / 'run_position.pkl', 'rb')),
           pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'MSK_341' / 'results' / 'run_sequence.pkl', 'rb'))
            ]
