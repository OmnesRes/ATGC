...
all_weights = [
    pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'VICC_01_R2' / 'results' / 'run_naive.pkl', 'rb')),
    pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'VICC_01_R2' / 'results' / 'run_position.pkl', 'rb')),
    pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'VICC_01_R2' / 'results' / 'run_sequence.pkl', 'rb'))
    ]
...
with open(cwd / 'figures' / 'tmb' / 'tcga' / 'VICC_01_R2' / 'results' / 'predictions.pkl', 'wb') as f:
