...
all_weights = [
    pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'VICC_01_R2' / 'results' / 'run_naive_shuffle.pkl', 'rb')),
    pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'VICC_01_R2' / 'results' / 'run_position_shuffle.pkl', 'rb')),
    pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'VICC_01_R2' / 'results' / 'run_sequence_shuffle.pkl', 'rb'))
    ]
