...
D, samples, maf, sample_df = pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'nonsyn_table' / 'MSK_341' / 'data' / 'data.pkl', 'rb'))
...
all_weights = [pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'nonsyn_table' / 'MSK_341' / 'results' / 'run_naive.pkl', 'rb')),
            ]
...
results['counting'] = np.log(sample_df['panel_all_counts'].values[np.concatenate(test_idx)] / (panels.loc[panels['Panel'] == 'MSK-IMPACT341']['cds'].values[0]/1e6) + 1)
