...
all_weights = [pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'nonsyn_table' / 'VICC_01_R2' / 'results' / 'run_naive.pkl', 'rb')),
            ]
...
results['counting'] = np.log(sample_df['panel_all_counts'].values[np.concatenate(test_idx)] / (panels.loc[panels['Panel'] == 'VICC-01-R2']['cds'].values[0]/1e6) + 1)
