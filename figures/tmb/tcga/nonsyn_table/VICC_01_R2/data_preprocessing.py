...
tcga_maf = tcga_maf.loc[(tcga_maf['VICC-01-R2'] > 0) & (tcga_maf['Variant_Classification'].isin(non_syn)) & (tcga_maf['CDS'] > 0)]
...
with open(cwd / 'figures' / 'tmb' / 'tcga' / 'nonsyn_table' / 'VICC_01_R2' / 'data' / 'data.pkl', 'wb') as f:
