...
tcga_maf = tcga_maf.loc[(tcga_maf['DFCI-ONCOPANEL-3'] > 0) & (tcga_maf['Variant_Classification'].isin(non_syn)) & (tcga_maf['CDS'] > 0)]
...
with open(cwd / 'figures' / 'tmb' / 'tcga' / 'nonsyn_table' / 'DFCI_ONCO' / 'data' / 'data.pkl', 'wb') as f:
