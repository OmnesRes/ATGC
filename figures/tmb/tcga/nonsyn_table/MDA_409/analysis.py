...
all_weights = [pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'nonsyn_table' / 'MDA_409' / 'results' / 'run_naive.pkl', 'rb')),
            ]
...
results['counting'] = np.log(sample_df['panel_all_counts'].values[np.concatenate(test_idx)] / (panels.loc[panels['Panel'] == 'MDA-409-V1']['cds'].values[0]/1e6) + 1)
