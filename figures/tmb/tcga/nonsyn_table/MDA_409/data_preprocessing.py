...
tcga_maf = tcga_maf.loc[(tcga_maf['MDA-409-V1'] > 0) & (tcga_maf['Variant_Classification'].isin(non_syn)) & (tcga_maf['CDS'] > 0)]
...
with open(cwd / 'figures' / 'tmb' / 'tcga' / 'nonsyn_table' / 'MDA_409' / 'data' / 'data.pkl', 'wb') as f:
