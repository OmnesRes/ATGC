...
D, samples, maf, sample_df = pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'nonsyn_table' / 'MSK_468' / 'data' / 'data.pkl', 'rb'))
...
with open(cwd / 'figures' / 'tmb' / 'tcga' / 'nonsyn_table' / 'MSK_468' / 'results' / 'run_naive.pkl', 'wb') as f:
