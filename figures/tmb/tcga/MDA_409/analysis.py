...
D, samples, maf, sample_df = pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'MDA_409' / 'data' / 'data.pkl', 'rb'))
...
all_weights = [pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'MDA_409' / 'results' / 'run_naive.pkl', 'rb')),
          pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'MDA_409' / 'results' / 'run_position.pkl', 'rb')),
           pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'MDA_409' / 'results' / 'run_sequence.pkl', 'rb'))
            ]
...
results['counting'] = np.log(sample_df['panel_non_syn_counts'].values[np.concatenate(test_idx)] / (panels.loc[panels['Panel'] == 'MDA-409-V1']['cds'].values[0]/1e6) + 1)

with open(cwd / 'figures' / 'tmb' / 'tcga' / 'MDA_409' / 'results' / 'predictions.pkl', 'wb') as f:
