...
all_weights = [pickle.load(open('figures/tmb/all_cancers/MDA_409/results/run_naive_shuffle.pkl', 'rb')),
           pickle.load(open('figures/tmb/all_cancers/MDA_409/results/run_position_shuffle.pkl', 'rb')),
           pickle.load(open('figures/tmb/all_cancers/MDA_409/results/run_sequence_shuffle.pkl', 'rb'))
            ]
