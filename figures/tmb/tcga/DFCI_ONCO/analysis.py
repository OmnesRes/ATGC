...
D, samples, maf, sample_df = pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'DFCI_ONCO' / 'data' / 'data.pkl', 'rb'))
...
all_weights = [pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'DFCI_ONCO' / 'results' / 'run_naive.pkl', 'rb')),
          pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'DFCI_ONCO' / 'results' / 'run_position.pkl', 'rb')),
           pickle.load(open(cwd / 'figures' / 'tmb' / 'tcga' / 'DFCI_ONCO' / 'results' / 'run_sequence.pkl', 'rb'))
            ]
...
with open(cwd / 'figures' / 'tmb' / 'tcga' / 'DFCI_ONCO' / 'results' / 'predictions.pkl', 'wb') as f:
