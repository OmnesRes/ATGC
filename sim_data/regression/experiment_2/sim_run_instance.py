...
weights = []
for i in range(3):
    mil = RaggedModels.MIL(instance_encoders=[tile_encoder.model], output_dim=1, pooling='mean', output_type='regression', instance_activation=None)
    losses = ['mse']
...
with open(cwd / 'sim_data' / 'regression' / 'experiment_2' / 'instance_model_mean.pkl', 'wb') as f:
