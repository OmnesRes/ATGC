...
for i in range(3):
    ...
    callbacks = [tf.keras.callbacks.EarlyStopping(monitor='val_mse', min_delta=0.00001, patience=50, mode='min', restore_best_weights=True)]
...
with open(cwd / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_mean.pkl', 'wb') as f:
