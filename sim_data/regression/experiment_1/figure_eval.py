...
sample_sum_attention_evaluations, sample_sum_attention_histories, weights = pickle.load(open(cwd / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_sum.pkl', 'rb'))
sample_mean_attention_evaluations, sample_mean_attention_histories, weights = pickle.load(open(cwd / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_mean.pkl', 'rb'))
sample_both_attention_evaluations, sample_both_attention_histories, weights = pickle.load(open(cwd / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_both.pkl', 'rb'))
sample_dynamic_attention_evaluations, sample_dynamic_attention_histories, weights = pickle.load(open(cwd / 'sim_data' / 'regression' / 'experiment_1' / 'sample_model_attention_dynamic.pkl', 'rb'))
