...
evaluations, histories, weights = pickle.load(open(cwd / 'sim_data' / 'regression' / 'experiment_3' / 'sample_model_attention_dynamic.pkl', 'rb'))
...
with open(cwd / 'sim_data' / 'regression' / 'experiment_3' / 'sample_model_attention_dynamic_predictions.pkl', 'wb') as f:
