...
sample_sum_before_evaluations, sample_sum_before_histories, weights = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_sum_before.pkl', 'rb'))
sample_sum_after_evaluations, sample_sum_after_histories, weights = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_sum_after.pkl', 'rb'))
sample_both_before_evaluations, sample_both_before_histories, weights = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_both_before.pkl', 'rb'))
sample_both_after_evaluations, sample_both_after_histories, weights = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_both_after.pkl', 'rb'))
sample_dynamic_before_evaluations, sample_dynamic_before_histories, weights = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_dynamic_before.pkl', 'rb'))
sample_dynamic_after_evaluations, sample_dynamic_after_histories, weights = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_dynamic_after.pkl', 'rb'))
