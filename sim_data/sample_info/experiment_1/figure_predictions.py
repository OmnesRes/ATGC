...
idx_test, attention, sample_sum_before_predictions = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_sum_before_attention.pkl', 'rb'))
idx_test, attention, sample_sum_after_predictions = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_sum_after_attention.pkl', 'rb'))
...
ax.set_yticks([])
ax.set_xticks([])
ax.set_xlim(0, sorted(np.concatenate(x_true))[-8] - 5)
ax.set_ylim(0, sorted(np.concatenate(predictions[0]))[-8] + 150)
...
plt.savefig(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'figure_predictions.png', dpi=300)
