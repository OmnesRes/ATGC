...
evaluations, histories, weights = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_sum_before.pkl', 'rb'))
# evaluations, histories, weights = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_sum_after.pkl', 'rb'))
...
with open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_sum_before_attention.pkl', 'wb') as f:
