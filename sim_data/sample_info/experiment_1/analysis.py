...
# evaluations, histories, weights = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_both_before.pkl', 'rb'))
evaluations, histories, weights = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_both_after.pkl', 'rb'))
...
with open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'sample_model_both_after_eval.pkl', 'wb') as f:
