...
for i in range(3):
    ...
    mil = RaggedModels.MIL(instance_encoders=[sequence_encoder.model, class_encoder.model], output_dim=2, pooling='sum')
...
with open(cwd / 'sim_data' / 'sample_info' / 'experiment_1' / 'instance_model_sum.pkl', 'wb') as f:
