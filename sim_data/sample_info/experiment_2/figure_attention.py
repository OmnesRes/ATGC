...
idx_test, sum_before_attentions, predictions = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_2' / 'sample_model_sum_before_eval.pkl', 'rb'))
idx_test, sum_after_attentions, predictions = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_2' / 'sample_model_sum_after_eval.pkl', 'rb'))
idx_test, both_before_attentions, predictions = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_2' / 'sample_model_both_before_eval.pkl', 'rb'))
idx_test, both_after_attentions, predictions = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_2' / 'sample_model_both_after_eval.pkl', 'rb'))
idx_test, dynamic_before_attentions, predictions = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_2' / 'sample_model_dynamic_before_eval.pkl', 'rb'))
idx_test, dynamic_after_attentions, predictions = pickle.load(open(cwd / 'sim_data' / 'sample_info' / 'experiment_2' / 'sample_model_dynamic_after_eval.pkl', 'rb'))
...
plt.savefig(cwd / 'sim_data' / 'sample_info' / 'experiment_2' / 'attention.png', dpi=300)
