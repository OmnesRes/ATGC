...
sample_both_attention_evaluations, sample_both_attention_histories, weights = pickle.load(open(cwd / 'sim_data' / 'classification' / 'experiment_2' / 'sample_model_attention_both.pkl', 'rb'))
sample_dynamic_attention_evaluations, sample_dynamic_attention_histories, weights = pickle.load(open(cwd / 'sim_data' / 'classification' / 'experiment_2' / 'sample_model_attention_dynamic.pkl', 'rb'))
