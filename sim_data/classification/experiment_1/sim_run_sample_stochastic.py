...
for i in range(3):
    ...
    callbacks = [tf.keras.callbacks.EarlyStopping(monitor='val_categorical_crossentropy', min_delta=0.00001, patience=10, mode='min', restore_best_weights=True)]
...
with open(cwd / 'sim_data' / 'classification' / 'experiment_1' / 'sample_model_mean_stochastic.pkl', 'wb') as f:
