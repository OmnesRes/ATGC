...
attentions = []
evaluations, histories, weights = pickle.load(open(cwd / 'sim_data' / 'classification' / 'experiment_4' / 'sample_model_attention_both.pkl', 'rb'))
for i in range(3):
...
with open(cwd / 'sim_data' / 'classification' / 'experiment_4' / 'both_attentions.pkl', 'wb') as f:
