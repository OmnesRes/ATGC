...
ds_train = ds_train.shuffle(buffer_size=len(idx_train)).batch(1)
...
with open(cwd / 'sim_data' / 'classification' / 'experiment_3' / 'sample_model_mean_stochastic.pkl', 'wb') as f:
