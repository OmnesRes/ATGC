...
attentions = []
evaluations, histories, weights = pickle.load(open(cwd / 'sim_data' / 'classification' / 'experiment_3' / 'sample_model_attention_mean.pkl', 'rb'))
for i in range(3):
...
with open(cwd / 'sim_data' / 'classification' / 'experiment_3' / 'mean_attentions.pkl', 'wb') as f:
