...
for i, j, k in zip(instance_sum_sample_dfs, sample_sum_sample_dfs, sample_sum_attention_sample_dfs):
    i['Model'] = 'Instance Sum'
    j['Model'] = 'Sample Sum'
    k['Model'] = 'Sample Attention Sum'

sample_df = instance_sum_sample_dfs[4].append(sample_sum_sample_dfs[4]).append(sample_sum_attention_sample_dfs[4])
