...
sample_sum_attention_indexes, sample_sum_attention_ranks, sample_sum_attention_sample_dfs = pickle.load(open(cwd / 'sim_data' / 'survival' / 'experiment_1' / 'sample_model_attention_sum_eval.pkl', 'rb'))
...
epochs = np.array([len(i['val_coxph']) - 10 for i in instance_sum_histories + sample_sum_histories + sample_sum_attention_histories])
