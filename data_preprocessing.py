...
path = '/home/jordan/Desktop/ATGC/files'
...
samples = samples.loc[~pd.isna(samples['OS.time']) & ~pd.isna(samples['age_at_initial_pathologic_diagnosis'])]

counts = samples.groupby('type')['OS'].value_counts()

to_use = ['ACC', 'BLCA', 'BRCA', 'CESC', 'COAD', 'ESCA', 'GBM', 'HNSC', 'KIRC', 'KIRP', 'LAML', 'LGG', 'LIHC', 'LUAD', 'LUSC', 'OV', 'PAAD', 'READ', 'SARC', 'SKCM', 'STAD', 'UCEC']
