...
cwd = pathlib.PosixPath('/home/janaya2/Desktop/ATGC_paper')
...
tcga_maf = tcga_maf.loc[(tcga_maf['MSK-IMPACT468'] > 0) & (tcga_maf['Variant_Classification'].isin(non_syn)) & (tcga_maf['CDS'] > 0)]
...
with open(cwd / '/home/janaya2/Desktop/ATGC2/MSK_tmb/data/all_cancers_data.pkl', 'wb') as f:
